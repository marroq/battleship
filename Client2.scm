...
(define (client)
	...
	(define (ataques)
		...
		(define salir #f)
		;CLIC QUE ESTARA ESPRANDO EL JUEGO PARA PROCEDER A HACER LAS VERIFICACIONES}
	...
	;********************************************************************************
	;FUNCIÓN QUE SE EJECUTA SOLAMENTE UNA VEZ EN TODO EL PROGRAMA, ES EL PRIMER ATAQUE RECIBIDO POR EL CONTRINCANTE, AL FINALIZAR SU ACCIÓN
	;SE DIRIGIRA A LA FUNCION DE ATAQUES EN DONDE SE EJECUTAN LAS MULTIPLES JUGADAS
	(define (firstA)
		;COORDENADA DE ATAQUE X RECIBIDA DEL SERVIDOR, ATAQUE QUE HA REALIZADO EL JUGADOR OPONENTE
		(set! COORDXA (read leer))
		(display "GOLPE EN X: ")
	...
	(set! ip (read-line))
	;VALUES LEER (INPUT-PORT) Y ENVIAR (OUTPUT-PORT)
